...
const registerUser = async(req, res)=>{
  try {
    ...
    await logMessage('UserService', 'info', `successfully register a for user: ${username}`);        
    ...
    await logMessage('UserService', 'error', `failed to register a for user ${error.message}`);
